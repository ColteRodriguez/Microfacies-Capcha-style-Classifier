...
def create_subdirectories(home, path):
    ...
    if os.path.exists(image_subdir):
        ...
        dirs = [image_subdir + '/Ooids', image_subdir + '/Mud', image_subdir + '/Bioclasts', image_subdir + '/Non-Sample', image_subdir + '/Unknown', image_subdir + '/Unlabeled']
...
def create_spreadsheet(home):
    ...
    col_names_const = ['Ooids', 'Mud', 'Bioclasts', 'Unknown', 'Total_mapped_area', '%Mapped', 'Alteration']
    col_names_sat = ['Organic Rich', 'Pore Space', 'Micritization-Cementation', ' ', ' ', ' ', ' ']
